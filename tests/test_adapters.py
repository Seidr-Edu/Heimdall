...
""".strip()
        ...
        self.assertEqual(kvasir_manifest["runner_timeout_sec"], 7200)
        self.assertEqual(kvasir_v2_manifest["runner_timeout_sec"], 7200)
        self.assertEqual(kvasir_v3_manifest["runner_timeout_sec"], 7200)
